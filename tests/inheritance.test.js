...
const Contact = require('../demo/crm/models/Contact');
const User = require('../demo/crm/models/User');
const ActivityMixin = require('../demo/crm/models/ActivityMixin');
const MessageMixin = require('../demo/crm/models/MessageMixin');
