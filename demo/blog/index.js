...
function logPerformance(label, startTime, startMemory) {
  ...
  console.log(`   💾 Memory delta: RSS ${formatMemory(memoryDelta.rss)}, Heap ${formatMemory(memoryDelta.heapUsed)}`);
...
async function demo() {
  ...
  console.log(`   💾 Total memory delta: RSS ${formatMemory(totalMemoryDelta.rss)}, Heap ${formatMemory(totalMemoryDelta.heapUsed)}`);
